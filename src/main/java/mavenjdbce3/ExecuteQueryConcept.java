...
////	4.Execute a query
//	statement.executeQuery("insert into User values(3,'gulshan','mysore')");
////  5.Close the connection=EXCEPTIONNNNNNNNNNNNNNNNN
//	connection.close();
...
//	3.Create a Statement
	Statement statement=connection.createStatement();
//	4.Execute a Query
    statement.executeQuery("update User set name='poojithajm' where id =2");
